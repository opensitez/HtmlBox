/// News reader demo showcasing:
///   - position: sticky  (top nav + section bars)
///   - aspect-ratio      (16/9 hero image, 3/2 card thumbnails, 1/1 avatars)
///   - column-count: 3   (article body)
///   - column-count: 2   (opinion grid)
        ...
        let window = Arc::new(
            event_loop.create_window(
                Window::default_attributes()
                    .with_title("TheWire — layout_features demo")
