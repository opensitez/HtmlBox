/// Port of wxhtmledit/examples/email_demo.cpp
/// Email-style layout showcase.
...
use rhtmledit::{Document, Renderer, LayoutEngine, load_html_vp, HtmlEventType};
        ...
        let window = Arc::new(
            event_loop.create_window(
                Window::default_attributes()
                    .with_title("email_demo — rhtmledit")
...
fn main() {
    ...
    let mut app = App {
        ...
        doc: None, width: 900.0, height: 800.0,
        mouse_pos: (0.0, 0.0),
    };
