/// Agent B renderer demo showcasing:
///   - CSS 2D transforms  — build_css_transform() composing scale/rotate/translate/skew/matrix
///   - CSS filters         — apply_css_filters() pixel-level blur/brightness/contrast/grayscale/
///                           hue-rotate/invert/opacity/saturate/sepia on the rendered region
///   - mix-blend-mode      — css_blend_mode() mapping to tiny-skia BlendMode
///   - Text decoration     — text_decoration_color, text_decoration_thickness,
///                           text_underline_offset; Solid/Double/Dotted/Dashed/Wavy styles
///   - position: sticky    — visual position clamped to top/left threshold within the viewport
...
use webcore::{load_html_vp, Document, Renderer, LayoutEngine, HtmlEventType};
        ...
        let window = Arc::new(
            event_loop.create_window(
                Window::default_attributes()
                    .with_title("Agent B — Transforms, Filters & Text Decoration")
...
fn main() {
    ...
    let mut app = App {
        ...
        doc: None, width: 1024.0, height: 768.0,
        mouse_pos: (0.0, 0.0),
    };
